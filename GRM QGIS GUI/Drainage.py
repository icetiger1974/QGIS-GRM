...
class Drainage:
    ...
    def __init__(self, iface):
        ...
        self.toolbar = self.iface.addToolBar(u'Drainage')
        self.toolbar.setObjectName(u'Drainage')

        #print "** INITIALIZING Drainage"
...
#                    철자 하나 밖에 없어서...
                self.dockwidget = DrainageDockWidget()
